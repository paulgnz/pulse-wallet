...
final class AppModel {
    ...
    private func loadSampleState() {
        ...
        assets = [
            Asset(symbol: "SYS", amount: 1_284.5012, precision: 4, contract: "pulse.token"),
            Asset(symbol: "XPR", amount: 50_000,    precision: 4, contract: "eosio.token")
        ]
        let now = Date(timeIntervalSince1970: 1_760_000_000)
        activity = [
            ActivityItem(kind: .received, counterparty: "metallicus", asset: "+250.0000 SYS",
                         memo: "grant", time: now, txid: "a1b2c3"),
            ActivityItem(kind: .sent, counterparty: "treasury.nz", asset: "-12.5000 SYS",
